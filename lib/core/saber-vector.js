 ...
 * @param value
 */
exports.negative = function (value) { return (value === 0 ? 0 : -1 * value); };
/**
 * 2 => 4
 * @param value
 */
...
var Vector2D = /** @class */ (function () {
    ...
    Vector2D.prototype.neg = function () {
        return new Vector2D(exports.negative(this.x), exports.negative(this.y));
    };
...
var Vector3D = /** @class */ (function () {
    ...
    Vector3D.prototype.neg = function () {
        return new Vector3D(exports.negative(this.x), exports.negative(this.y), exports.negative(this.z));
    };
